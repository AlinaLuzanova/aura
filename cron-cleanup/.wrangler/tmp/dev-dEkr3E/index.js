...
var index_default = {
  async scheduled(event, env, ctx) {
    const TTL_DAYS = 30;
    const cutoff = Date.now() - TTL_DAYS * 24 * 60 * 60 * 1e3;
...
// .wrangler/tmp/bundle-aMKd41/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-aMKd41/middleware-loader.entry.ts
